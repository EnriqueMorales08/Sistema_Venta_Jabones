...
public class suscripcion extends HttpServlet {
    ...
    public void sendMail(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        String msj = " °-°-°-°-°-Noticias Brisa Natural-°-°-°-°-°";
        //rnjejagdxjfczzys
        String pass = "rnjejagdxjfczzys";
        String dest = correo01;
        String content = "Correo: " + correo01 + "\n\nSe ha suscrito para recibir noticias:\n\n " + msj;
        Session sess;
        ...
        try {
            ...
            mime.setSubject("NOTICIAS BRISA NATURAL");
